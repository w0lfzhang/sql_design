  ...
  <form action="handleinsert.jsp" method="post"> 
    <section class="loginForm"> 
      ...
      <div class="loginForm_content"> 
        <fieldset> 
          <div class="inputWrap"> 
            <input type="text" name="cvename" placeholder="cvename" autofocus required> 
          </div> 
          <div class="inputWrap"> 
        ...
        <fieldset> 
          <div class="inputWrap">
          	type:<br>
            <input type="radio" name="type" value="remote exploit" required>remote exploit<br>
            <input type="radio" name="type" value="web application exploit" required>web application exploit<br>
            <input type="radio" name="type" value="Local and Privilege Escalation Exploits" required>Local and Privilege Escalation Exploits<br>
            <input type="radio" name="type" value="Denial of Service and PoC Exploits" required>Denial of Service and PoC Exploits
          </div> 
        </fieldset>
        ...
        <fieldset> 
          <div class="inputWrap">
          	platform:<br>
            <input type="radio" name="platform" value="windows" required>windows
            <input type="radio" name="platform" value="linux" required>linux
            <input type="radio" name="platform" value="mac" required>mac
            <input type="radio" name="platform" value="android" required>android
            <input type="radio" name="platform" value="iphone" required>iphone
          </div> 
        </fieldset> 
