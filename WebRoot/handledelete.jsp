...
margin-left:580px;
  ...
  if( flag == true ){
  	  out.print("<center><h3>Delete success!</h3></center><br>");
  	  out.println("<center><h3>Delete Used time：" + sdf.format(new Date(endTime - startTime)) + "</h3></center>");
  }else{
      out.print("NO such record! Delete failed!");
  }
  %>
